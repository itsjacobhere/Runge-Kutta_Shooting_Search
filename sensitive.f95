...
program wastewater
    ...
    real(wp) :: p_in, lim,conc_algal, percent
...
!___________________________________________________________________
    ...
    sensitivity: do i = 90,110,1
        
        !i = .9*velocity,1.1*velocity,.01*velocity
        velocity = 0.06_wp
        velocity = velocity*((real(i))/100)
        ...
        write(*,*) i, "velocity = ",velocity, "snew=", snew
